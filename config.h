...
static const char *fonts[]          = { "monospace:size=11", "fontawesome:pixelsize=10:"};
...
static Key keys[] = {
	...
	{ MODKEY,			XK_c,		spawn,		SHCMD("$BROWSER codeforces.com") },
	...
	{ MODKEY,			XK_n,		spawn,		SHCMD("setbg ~/Pictures/wallpapers") },
